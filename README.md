...
- **Tipo di contratto**: tempo indeterminato (default) o apprendistato, che porta
  l'aliquota INPS del lavoratore da 9,19%/9,49% a 5,84% flat
...
due volte e con fonti indipendenti, che non altera nessun numero rispetto al
...
- Le **semplificazioni sono dichiarate**, non nascoste: vivono in questo README e
  nel PDF metodologico, con la ragione di ciascuna esclusione.
...
RAL
 − contributi INPS c/dipendente        9,19%/9,49% standard, o 5,84% flat se
                                        apprendistato (art. 21 c.6 L. 41/1986)
...
- **Vitest**: 136 test sul motore di calcolo, unitari per modulo, end-to-end sui
